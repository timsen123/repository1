		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Stock Status",
									"targetURL": "#stockstatusstockstatus-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"stockstatusstockstatus-display": {
								"semanticObject": "stockstatusstockstatus",
								"action": "display",
								"description": "QE2E Stock Status",
								"title": "Stock Status",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=stockstatus.stockstatus",
									"url": sap.ui.require.toUrl("stockstatus/stockstatus")
								}
							}
						}
					}
